...
![note](../images/note_24.png) To create a domain name bucket, you will have to verify that you are the owner of the domain.
...
![note](../images/note_24.png) The maximum database size may change in the future.
