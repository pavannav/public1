...
Table 2-5. Examples of the number of training tokens for models with different numbers of parameters. Source: “Training Compute-Optimal Large Language Models” ([DeepMind, 2022](https://oreil.ly/A3K90)).
...
Table 2-6. Examples of demonstration data used for [InstructGPT](https://arxiv.org/abs/2203.02155).
...
![A screenshot of a computer Description automatically generated](../images/aien_0226.png)
...
[30](https://learning.oreilly.com/library/view/ai-engineering/9781098166298/ch02.html#id835-marker) As of this writing, in the OpenAI API, you can set the parameter [best\_of](https://oreil.ly/XYugZ) to a specific value, say 10, to ask OpenAI models to return the output with the highest average logprob out of 10 different outputs.
