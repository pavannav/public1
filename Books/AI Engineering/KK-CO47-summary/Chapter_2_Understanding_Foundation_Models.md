...
![A graph with green and blue bars Description automatically generated](../images/aien_0201.png)
...
![A graph with numbers and a number of pass rate Description automatically generated](../images/aien_0202.png)
...
![A diagram of a algorithm Description automatically generated with medium confidence](../images/aien_0204.png)
...
![A graph with dots and lines Description automatically generated](../images/aien_0208.png)
...
![A graph of data being measured Description automatically generated with medium confidence](../images/aien_0209.png)
...
On top of that, the internet is being rapidly populated with data generated by AI models. If companies continue using internet data to train future models, these new models will be partially trained on AI-generated data. In December 2023, Grok, a model trained by X, was caught refusing a request by saying that it goes against OpenAI's use case policy. This caused some people to speculate that Grok was trained using ChatGPT outputs. Igor Babuschkin, a core developer behind Grok, responded that it was because Grok was trained on web data, and "the web is full of ChatGPT outputs."
...
![A diagram of a data analysis Description automatically generated](../images/aien_0210.png)
...
![A drawing of a monster Description automatically generated](../images/aien_0211.png)
...
![A colorful circle with text on it Description automatically generated](../images/aien_0212.png)
...
![Screenshot of a screenshot of a computer screen Description automatically generated](../images/aien_0213.png)
...
![A diagram of a color Description automatically generated](../images/aien_0214.png)
...
![A diagram of a network Description automatically generated](../images/aien_0215.png)
...
![A graph with a line Description automatically generated](../images/aien_0216.png)
...
![A diagram of a softmax Description automatically generated](../images/aien_0217.png)
...
![A screenshot of a computer Description automatically generated](../images/aien_0218.png)
...
![A graph with blue lines and numbers Description automatically generated](../images/aien_0219.png)
...
1. *Tasks requiring structured outputs.* The most common category of tasks in this scenario is semantic parsing. Semantic parsing involves converting natural language into a structured, machine-readable format. Text-to-SQL is an example of semantic parsing, where the outputs must be valid SQL queries. Semantic parsing allow users to interact with APIs using a natural language (e.g., English). For example, text-to-PostgreSQL allows users to query a Postgres database using English queries such as "What's the average monthly revenue over the last 6 months" instead of writing it in PostgreSQL.
   ...
   ```
   System prompt Given an item, create a regex that represents all the ways the item can be
   written. Return only the regex.

   Example:
   US phone number -> \+?1?\s?(\()?(\d{3})(?(1)\))[-.\s]?(\d{3})[-.\s]?(\d{4})

   User prompt Email address ->
...
![A screenshot of a computer Description automatically generated](../images/aien_0220.png)
...
![A diagram of a software model Description automatically generated](../images/aien_0221.png)
...
![A diagram of a layer Description automatically generated](../images/aien_0222.png)
...
![A screenshot of a computer Description automatically generated](../images/aien_0223.png)
...
![A bottle of milk with instructions Description automatically generated](../images/aien_0224.png)
...
![A screenshot of a computer Description automatically generated](../images/aien_0225.png)
...
![../images/aien_0226.png](image)

**Figure 2-26. RLHF made hallucination worse for InstructGPT, but overall, human labelers still preferred the RLHF model.**